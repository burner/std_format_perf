...
Source: $(PHOBOSSRC stdx.format/write.d)
 */
module stdx.format.write;
...
$(MREF_ALTTEXT compound specifiers, stdx.format) characters are
treated differently.
 */
@safe pure unittest
{
...
compound specifiers, stdx.format) strings are treated differently.
 */
@safe pure unittest
{
    import std.array : appender;
...
{
    import std.array : appender;
    import stdx.format.spec : FormatSpec, singleSpec;
...
import stdx.format.internal.write;
...
{
    import stdx.format : checkFormatException;
...
$(MREF_ALTTEXT format string, stdx.format).
