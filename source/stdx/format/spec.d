...
$(MREF_ALTTEXT format string, stdx.format) and provides tools for
...
Source: $(PHOBOSSRC stdx.format/spec.d)
 */
module stdx.format.spec;
...
which parses the $(MREF_ALTTEXT format string, stdx.format) until the
...
if (is(Unqual!Char == Char))
{
    ...
    /**
       ...
       See $(MREF_ALTTEXT format string, stdx.format) for more details.
    ...
    */
    ...
    /**
       ...
       Params:
           fmt = a $(MREF_ALTTEXT format string, stdx.format)
     */
    ...
    /**
       ...
       See the $(MREF_ALTTEXT description of format strings, stdx.format) for more
       ...
       Throws:
           A $(REF_ALTTEXT FormatException, FormatException, stdx.format)
    ...
    {
        import stdx.format : enforceFmt, FormatException;
...
Throws:
    A $(REF_ALTTEXT FormatException, FormatException, stdx.format) when the
...
{
    import stdx.format.internal.write : evfs = enforceValidFormatSpec;
...
{
    import std.exception : collectExceptionMsg;
    import stdx.format : format, FormatException;
