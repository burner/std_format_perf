...
/*
   ...
   Source: $(PHOBOSSRC stdx.format/internal/read.d)
 */
module stdx.format.internal.read;
...
if (isInputRange!Range && is(immutable T == immutable bool))
{
    ...
    import stdx.format : enforceFmt, unformatValue;
...
{
    import std.range.primitives : empty, front, popFront;
    import stdx.format : enforceFmt, format;
...
if (isInputRange!Range)
{
    ...
    import stdx.format.read : unformatValue;
